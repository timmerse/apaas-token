...
在客户端访问API，获取apaasToken：`https://{YOUR_SERVICE}.apigw.tencentcs.com/base/v1/apaas/token?userId=12345678`
...
> A: 若能在浏览器访问，则网关正常：`https://{YOUR_SERVICE}.apigw.tencentcs.com/helloworld`

Q: 如何确认函数创建成功？

> A: 若能在浏览器访问，则函数创建正常：`https://{YOUR_SERVICE}.apigw.tencentcs.com`
